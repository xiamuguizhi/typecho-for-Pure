 ...
 */
	   ...
	   $(".post-content img").each(function(i) {
		  if (!this.parentNode.href) {
			 $(this).wrap("<a class=\"a_css\" href='" + this.alt + "' data-fancybox='fancybox' data-caption='" + randomString(8) + "'></a>")
		  }
	   });
		  $(".post-content div img").each(function(i) {
		  if (!this.parentNode.href) {
			 $(this).wrap("<a href='" + this.alt + "' data-fancybox='fancybox' data-caption='" + randomString(8) + "'></a>")
		  }
	   });
	});